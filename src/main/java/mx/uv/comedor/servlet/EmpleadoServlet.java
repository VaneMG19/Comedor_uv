...
/**
 * Panel del empleado de cocina.
 *
 * GET  /empleado/dashboard  → lista pedidos activos
 * POST /empleado/estado     → cambia estado de un pedido
 */
...
public class EmpleadoServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            ...
            req.getRequestDispatcher("/WEB-INF/vistas/empleado/dashboard.jsp")
               .forward(req, resp);
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            ...
            EstadoPedidoEnum  nuevoEstado =
                EstadoPedidoEnum.valueOf(req.getParameter("nuevoEstado"));
            String            comentario  = req.getParameter("comentario");

            // Obtener el empleado en sesión
            ...
            resp.sendRedirect(req.getContextPath() +
                "/empleado/dashboard?exito=estadoActualizado");
    ...
    private boolean esEmpleado(HttpServletRequest req, HttpServletResponse resp)
            throws IOException {
        HttpSession session = req.getSession(false);
